...
public func drawAxes(context: inout GraphicsContext, chartRect: CGRect, color: Color = .secondary, lineWidth: CGFloat = 1) {
    var xAxis = Path()
...
public func evenlySpacedTickIndices(count: Int, targetCount: Int) -> [Int] {
