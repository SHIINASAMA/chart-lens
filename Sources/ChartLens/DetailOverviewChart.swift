...
public struct DetailOverviewChart<DetailOverlay: View, OverviewOverlay: View>: View {
    ...
    public var detailHeight: CGFloat = 280
    public var overviewHeight: CGFloat = 48
    public var followMax: Bool = false

    public var detailStyle: ChartStyle = .init(leftAxisWidth: 40, bottomAxisHeight: 24, marginTop: 40, marginRight: 8, marginBottom: 4)
    public var overviewStyle: ChartStyle = .init(leftAxisWidth: 0, bottomAxisHeight: 0, marginTop: 0, marginRight: 0, marginBottom: 0)
    public var detailAxis: ChartAxisConfig = .init()
    public var overviewAxis: ChartAxisConfig = .init()

    /// Formats domain values into axis labels.
    public var domainLabel: (Double) -> String = { String(format: "%.0f", $0) }
    ...
    public var onHover: (Double?) -> Void = { _ in }
