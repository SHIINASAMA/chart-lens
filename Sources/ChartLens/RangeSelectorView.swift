...
public enum SelectorDragMode { case idle, resizeLeft, panWindow, resizeRight }

public enum SelectorHoverTarget: Equatable { case leftHandle, body, rightHandle }

public struct SelectorDragState {
...
public struct RangeSelector<Content: View>: View {
    ...
    public var edgeLabel: (Double) -> String = { String(format: "%.0f", $0) }
    /// Called when the visible window changes.
    public var onWindowChange: ((start: Double, end: Double)) -> Void = { _ in }
